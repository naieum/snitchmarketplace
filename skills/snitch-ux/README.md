...
/plugin install snitch-ux@snitch
```
...
**Learn more:** [snitchplugin.com/ux](https://snitchplugin.com/ux) · [Docs](https://snitchplugin.com/docs/ux) · [Docs as markdown](https://snitchplugin.com/docs/ux.md)
