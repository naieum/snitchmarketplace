...
|---|---|---|---|---|---|
| **Capacitor** | Native shell + plugin bridge around the existing web build | ✅ with 4.2 caveat below | ✅ with webview-spam caveat | Days–weeks | Existing SPA; one codebase for both stores; native plugins (push, camera, biometrics) available to clear the minimum-functionality bar |
...
| **React Native / Expo** | Native UI rewrite reusing business logic and APIs | ✅ | ✅ | Weeks–months | Webview UX/perf will not clear 4.2, or the product needs deep native integration |
